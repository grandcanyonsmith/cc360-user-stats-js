...
const Filters = ({ onFilterChange, users, filterState, setIsFilterPanelOpen }) => {
                ...
                <div className="border-t border-gray-200 px-4 py-6">
                  ...
                  <div className="pt-6" id="filter-section-10">
                    <div className="space-y-6">
                      ...
                      <div className="flex items-center">                          <input id="filterOnboardingCompletedStatusTrue" name="filterOnboardingCompletedStatus" value="true" type="radio" className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" checked={filterState.onboardingCompleted === 'true'} onChange={handleFilterChange} />
